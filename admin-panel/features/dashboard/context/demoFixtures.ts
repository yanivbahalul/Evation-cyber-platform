...
export const MOCK_TOKENS: HoneyToken[] = [
  {
    ...
    fakeUsername: 'hr.integration@innotech.io',
    fakePassword: 'itc_live_8f3c9a2b7e1d4f60a5c8b9d2e3f10472',
    tokenType: 'api_key',
    ...
    isTriggered: true,
    triggeredLogs: [
      { attackerIp: '1.2.3.4', timestamp: '2024-05-07T23:55:01Z', networkContext: 'HTTP', method: 'GET', path: '/internal/api/v1/hr/export?page=1&limit=25', outcome: 200 },
      { attackerIp: '45.155.205.10', timestamp: '2024-05-07T18:30:00Z', networkContext: 'HTTP', method: 'GET', path: '/internal/api/v1/hr/export', outcome: 429 },
    ],
  },
  {
    _id: 'ht2',
    catalogId: 'aws-backup-key',
    fakeUsername: 'svc_backup@innotech.io',
    fakePassword: 'AKIA5INNOTECHBKUP01X',
    tokenType: 'aws_key',
    service: 'backup-s3',
  ...
  },
  {
    ...
    fakeUsername: 'monitoring.agent@innotech.io',
    fakePassword: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiJzdmMtbW9uaXRvcmluZyJ9.r5C8m2Qe1x',
    tokenType: 'jwt',
    ...
    isTriggered: true,
    triggeredLogs: [
      { attackerIp: '185.220.101.5', timestamp: '2024-05-07T22:05:00Z', networkContext: 'HTTP', method: 'GET', path: '/internal/api/v1/hr/export', outcome: 403 },
    ],
  },
]
